...
-- ALTER TABLE RECIPE ADD COLUMN text_for_fts TEXT;

-- UPDATE TEST_TABLE 
-- JOIN RECIPE_TEXT  ON TEST_TABLE.ID = RECIPE_TEXT.RECIPE_ID
-- SET TEST_TABLE.TEXT_FOR_FTS = RECIPE_TEXT.TEXT;

-- UPDATE RECIPE 
-- JOIN RECIPE_TEXT  ON RECIPE.ID = RECIPE_TEXT.RECIPE_ID
-- SET RECIPE.TEXT_FOR_FTS = RECIPE_TEXT.TEXT;

-- UPDATE RECIPE 
-- JOIN RECIPE_TEXT  ON RECIPE.ID = RECIPE_TEXT.RECIPE_ID
-- SET RECIPE.TEXT_FOR_FTS = RECIPE_TEXT.TEXT
-- WHERE RECIPE.ID > (SELECT MAX(RECIPE.ID) FROM RECIPE WHERE RECIPE.TEXT_FOR_FTS IS NOT NULL)
-- ORDER BY RECIPE.ID
-- LIMIT 10000